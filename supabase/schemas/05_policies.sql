...
-- Catalog Links
create policy "Enable read access for authenticated users" on public.catalog_links for select to authenticated using (true);
create policy "Enable insert for authenticated users only" on public.catalog_links for insert to authenticated with check (true);
create policy "Catalog Link Update Policy" on public.catalog_links for update to authenticated using (true);
create policy "Catalog Link Delete Policy" on public.catalog_links for delete to authenticated using (true);
